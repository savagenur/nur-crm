...
# class AssignAgentV(OrganisorAndLoginRequiredMixin, generic.FormView):
#     template_name = 'leads/assign_agent.html'
#     form_class = AssignAgentF
#
#     def get_form_kwargs(self, **kwargs):
#         kwargs = super(AssignAgentV, self).get_form_kwargs(**kwargs)
#         kwargs.update({
#             'request': self.request
#         })
#         return kwargs
...
#         lead.agent = agent
#         lead.save()
#         return super(AssignAgentV, self).form_valid(form)
